...
/** 
 * class {@code UtilityService} is the utility class which will
 * basically includes Static methods. The methods in the class has a
 * specific job to do as that can be inferred by there name.
 *
 */
public class UtilityService {
	...
	/*
	 * code {@code isValidLicensePlate} method checks for the validity
	 * of the vehicleLicensePlateNumber.
	 */
