 ...
 * interface. 
 * All methods of this class are being defined for the different event driven 
 * functionalities
 *
 */
public class ParkingControllerImpl implements ParkingController {
	...
	/*
	 * (non-Javadoc)
	 * @see com.gondor.rahul.parking.controllers.ParkingController#start()
	 * This method is called at the startup, it initializes the ParkingLot object,
	 * and ask for the choice of entry or exit in a parking lot.
	 * This also makes a call to the parkingService service for the display 
	 * of the summary board of the Parking Lot.
	 * 
	 */
	@Override
	public void start() {
	...
	/*
	 * (non-Javadoc)
	 * @see com.gondor.rahul.parking.controllers.ParkingController#vehicleEntry()
	 * This method is the entry point for incoming vehicles.
	 * It prompt the user to enter the vehicle type and vehicle no and adds
	 * the vehicle to the list if not present or if it is repeat vehicle then,
	 * get the object  from the vehiclesList map object.
	 * After Getting the required details ,it calls the placeVehicle service of
	 * the ParkingService service
	 */
	@Override
	public void vehicleEntry() throws Exception{
		...
		System.out.println("Floor Number:"+ parkingTicket.getFloorIndex() +"  Spot Number :" + parkingTicket.getSlotNumber() + "   StackLevel "+parkingTicket.getLevel());
	 ...
	 * user for the vehicle number and type and then call the removeVehicleFromSlot
	 * method if found
	 * 
	 */
	@Override
	...
	/*
	 * this is a private method which checks for the validity of the licensePlate,
	 * or whether it is there in the parking log
	 */
	...
	/*
	 * this is a private method which checks for the validity of the licensePlate,
	 * and whether the particular vehicle has been assigned a slot or not
	 */
